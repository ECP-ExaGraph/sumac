...
class GraphGPU
{
  private:
    ...
    bool* problematic_verts_device_[NGPU];
    bool* problematic_verts_host_;
  ...
  public:
    ...
    void run_pointer_chase(int batch_id);
    void move_batch_to_GPU(int batch_id);
