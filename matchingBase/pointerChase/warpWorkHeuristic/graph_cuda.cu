...
)
{
    ...
    long long nblocks = MAX_GRIDDIM;
    int vertsPerThread = ((vertex_per_batch_[batch_id+1] - vertex_per_batch_[batch_id])/(MAX_GRIDDIM * threadCount))+1;
    printf("VPT: %d\n",vertsPerThread);
    CudaSetDevice(device_id);
    //Run Mate Kernel
...
void run_pointer_chase_p1_work
(
    GraphElem* indices_,
    GraphWeight* edgeWeights_,
    GraphElem* edgeList_,
...
)
{
    ...
    CudaLaunch((set_mate_kernel_work<BLOCKDIM02><<<nblocks,threadCount>>>
    (indices_,edgeWeights_,edgeList_,mate_,partners_,vertex_per_batch_device_,vertex_per_device_,device_id,batch_id,vertsPerWarp,warpWork)));
    //CudaLaunch((set_mate_kernel<BLOCKDIM02><<<nblocks,threadCount>>>
    //(indices_,edgeWeights_,edgeList_,mate_,partners_,vertex_per_batch_device_,vertex_per_device_,device_id,batch_id,vertsPerWarp)));
